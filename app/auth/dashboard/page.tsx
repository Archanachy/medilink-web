      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-24">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <Link href="/user/profile" className="p-4 border-2 border-gray-200 rounded-lg hover:border-indigo-500 hover:bg-indigo-50 transition-all text-left">
            ...
            <button className="p-4 border-2 border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-all text-left">
              <h3 className="font-semibold text-gray-900 mb-1">Schedule Appointment</h3>
            ...
            <button className="p-4 border-2 border-gray-200 rounded-lg hover:border-purple-500 hover:bg-purple-50 transition-all text-left">
              ...
              <p className="text-sm text-gray-600">Access health records</p>
            </button>
          </div>
        </div>

        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-xl p-6">
          <h3 className="text-lg font-semibold text-blue-900 mb-2">🎉 Welcome to Medilink!</h3>
